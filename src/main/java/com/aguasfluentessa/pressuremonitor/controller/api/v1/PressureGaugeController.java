...
public class PressureGaugeController {
    ...
    public PressureGaugeController(PressureGaugeService pressureGaugeService) {
        this.pressureGaugeService = pressureGaugeService;
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PressureGauge> updatePressureGauge(@PathVariable Long id,
            @RequestBody PressureGauge pressureGauge) {
    ...
    public ResponseEntity<PressureGauge> showPressureGaugeByGaugeUniqueIdentificator(
            @PathVariable String gaugeUniqueIdentificator) {
    ...
    public ResponseEntity<Void> deletePressureGaugeByGaugeUniqueIdentificator(
            @PathVariable String gaugeUniqueIdentificator) {
